...
I am now working on ***Multi-modal Data Analysis***, ***Scalable Unsupervised Learning*** and ***graph learning***. I have published 40+ papers at the top international AI conferences and journals, such as NeurIPS, ICML, ICLR, CVPR, ICCV, AAAI and IEEE TIP, TKDE, TNNLS. I also serve as reviewer for top conferences, including ICLR, NeurIPS, ICML, CVPR, ICCV, AAAI and ACM MM.
